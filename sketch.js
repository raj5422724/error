...
if(player1.x>player2.x){
  ...
  if(weapon12.isTouching(player2)&&keyDown("space")&&frameCount%3===0&&player2.x>player1.x||trident1.isTouching(player2)&&player2.x>player1.x&&player2.x-player1.x>=600){
    h2--;  
    switch(h2){
      case 7:hearts2.addImage(heart7)
      hearts2.scale=0.4;
